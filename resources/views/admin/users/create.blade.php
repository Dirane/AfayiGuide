        ...
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="academic_level" id="academic_level"
                        ...
                        <option value="advanced_level" {{ old('academic_level') == 'advanced_level' ? 'selected' : '' }}>Advanced Level</option>
                        <option value="hnd" {{ old('academic_level') == 'hnd' ? 'selected' : '' }}>HND</option>
                        <option value="degree" {{ old('academic_level') == 'degree' ? 'selected' : '' }}>Degree</option>
                        <option value="other" {{ old('academic_level') == 'other' ? 'selected' : '' }}>Other</option>
                    </select>
            ...
            <div>
                ...
                <textarea name="interests" id="interests" rows="3"
                          ...
                          placeholder="Enter user interests">{{ old('interests') }}</textarea>
                @error('interests')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
