...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Add a new opportunity for students</p>
        </div>
    ...
    <div class="card">
        <form action="{{ route('admin.opportunities.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Upload an image for the opportunity (max 2MB)</p>
                @error('image')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
