...
class AssessmentController extends Controller
{
    ...
    {
        $assessments = PathfinderResponse::with('user')->latest()->paginate(15);
    ...
    public function export()
    {
        ...
        $callback = function() use ($assessments) {
            ...
            // Add headers
            fputcsv($file, [
                'ID', 'User', 'Email', 'Academic Background', 'Field of Interest',
                'Career Goals', 'Aspirations', 'Skills', 'Interests', 'Location',
                'Budget Range', 'Notes', 'Created At'
            ]);
            ...
            foreach ($assessments as $assessment) {
                fputcsv($file, [
                    ...
                    is_array($assessment->skills) ? implode(', ', $assessment->skills) : $assessment->skills,
                    is_array($assessment->interests) ? implode(', ', $assessment->interests) : $assessment->interests,
